...
assert.ok(html.includes('app-v240-release.js?v=2830'),'The iPad must request the fresh v2.8.3 release loader');
...
console.log('PASS: 240 entries, v2.8.3 loader, mock 20, compact writing and side-by-side review, school hooks and separate module safety.');
