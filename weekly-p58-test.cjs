...
run("CURRENT_KANJI_PACK_ID='2026-09-21-p58';useKanjiPack(CURRENT_KANJI_PACK_ID)");
...
assert.equal(run('KANJI_PACKS.length'),3,'The previous, p58, and p62 packs are retained');
