...
(() => {
  ...
  loadSequence([
    ...
    if(island?.open&&!island.open.__v292Version){const previous=island.open;island.open=function(...args){const out=previous.apply(this,args);setVersion();return out;};island.open.__v292Version=true;}
  });
})();
