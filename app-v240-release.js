// v2.8.6: direct-on-paper answers plus past-paper intent for every Kanji 9 section; preserve school study.
(() => {
  ...
  function paperStyles(){if(!document.getElementById('k9ExamStyleV283')){const css=document.createElement('link');css.id='k9ExamStyleV283';css.rel='stylesheet';css.href='./kanken9-exam-v283.css?v=2830';document.head.appendChild(css);}if(!document.getElementById('k9PaperUxStyleV284')){const css=document.createElement('link');css.id='k9PaperUxStyleV284';css.rel='stylesheet';css.href='./kanken9-paper-ux-v284.css?v=2840';document.head.appendChild(css);}if(!document.getElementById('k9PaperLayoutV285')){const css=document.createElement('link');css.id='k9PaperLayoutV285';css.rel='stylesheet';css.href='./kanken9-paper-layout-v285.css?v=2850';document.head.appendChild(css);}if(!document.getElementById('k9InlineStyleV286')){const css=document.createElement('link');css.id='k9InlineStyleV286';css.rel='stylesheet';css.href='./kanken9-inline-v286.css?v=2860';document.head.appendChild(css);}}
  ...
  ],()=>{refresh();window.MioriV250?.polishIsland?.();window.MioriKanken9V280?.count?.();window.MioriKankenViewportV282?.adapt?.();window.MioriKankenPaperV283?.decorate?.();window.MioriKankenDailyV286?.decorate?.();window.MioriKankenInlineV286?.apply?.();});
})();